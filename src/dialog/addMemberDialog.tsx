...
export default function AddMemberDialog({ onDiscardAddMemberDialog, onSuccessAddMemberDialog, open }: AddMemberDialogProps) {
    ...
    return (
        <>
            <Dialog open={open} onClose={handleClose} sx={{ m: 1, width: 300 }}>
